...
android {
    namespace = "ru.wertik.orca.compose.material3"
    compileSdk = 36
...
publishing {
    publications.withType<MavenPublication>().configureEach {
        ...
        val publicationArtifactId = "orca-compose-material3$platformSuffix"
        ...
        pom {
            name.set("Orca Compose Material 3")
            description.set("Optional Material 3 theme adapter for Orca Compose")
